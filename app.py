...
cleaned_data = cleaned_data.drop(columns=["perimeter_mean", "area_mean", "perimeter_se", "area_se", "perimeter_worst", "area_worst"])
...
cleaned_data = cleaned_data.drop(columns=[ "smoothness_mean", "compactness_mean", "symmetry_mean", "fractal_dimension_mean",
...
# Model seçimi
model_name = st.sidebar.selectbox("Model Seç:", ("KNN", "SVM", "Gaussian Naive Bayes", "Multinomial Naive Bayes", "Bernoulli Naive Bayes"))
...
scoring_metrics = ['accuracy', 'precision', 'recall', 'f1'] # Değerlendirme metrikleri: accuracy, precision, recall, f1
